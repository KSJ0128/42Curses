...
/*   Updated: 2024/07/15 15:52:40 by seojkim          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "push_swap.h"

void	optimize_a_b(t_deq *stack_a, t_deq *stack_b, int rol_a, int rol_b)
{
	rol_a = stack_a->size - rol_a;
	rol_b = stack_b->size - rol_b;
	while (rol_a > 0 && rol_b > 0)
	{
